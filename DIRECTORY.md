...
## Divide And Conquer
  ...
  * [Mergesort](https://github.com/TheAlgorithms/Python/blob/master/divide_and_conquer/mergesort.py) O(nlogn)
...
## Maths
  ...
  * [Abs](https://github.com/TheAlgorithms/Python/blob/master/maths/abs.py) O(c)
  * [Abs Max](https://github.com/TheAlgorithms/Python/blob/master/maths/abs_max.py) O(n)
  * [Abs Min](https://github.com/TheAlgorithms/Python/blob/master/maths/abs_min.py) O(n)
  ...
  * [Average Mean](https://github.com/TheAlgorithms/Python/blob/master/maths/average_mean.py) O(n)
  ...
  * [Find Max](https://github.com/TheAlgorithms/Python/blob/master/maths/find_max.py) O(n)
  * [Find Max Recursion](https://github.com/TheAlgorithms/Python/blob/master/maths/find_max_recursion.py)
  * [Find Min](https://github.com/TheAlgorithms/Python/blob/master/maths/find_min.py) O(n)
